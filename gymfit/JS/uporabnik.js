function podatkiUporabnika()
{
	...
	xmlhttp.open("GET", "http://192.168.64.109/gymfitAPI/uporabniki/"+ID_uporabnika, true);							
	xmlhttp.send();													
}

function profilUporabnika()
{
...
function podatkiVsihUporabnika()
{
	...
	xmlhttp.open("GET", "http://192.168.64.109/gymfitAPI/uporabniki", true);							
	xmlhttp.send();													
}
...
function posodobiPodatke()
{
	...
	xmlhttp.open("PUT", "http://192.168.64.109/gymfitAPI/uporabniki/"+ID_uporabnika, true);							
...
function izbrisiUporabnika()
{
	...
	xmlhttp.open("DELETE", "http://192.168.64.109/gymfitAPI/uporabniki/"+ID_uporabnika, true);					
	xmlhttp.send();													
}
